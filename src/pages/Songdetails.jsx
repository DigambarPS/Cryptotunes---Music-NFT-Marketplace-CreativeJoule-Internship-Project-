...
function Songdetails({ purchaseProduct, account }) {
      ...
      <div className="songdetails">
        ...
        <div className="detailsflex">
          ...
          <div className="songdetailprice">
            <h3>
              PRICE :{" "}
              {window.web3.utils.fromWei(locationState.musicPrice.toString())}{" "}
            </h3>
            ...
            {locationState.purchased === false ? (
              <button
                ...
                onClick={(event) => {
                  ...
                  purchaseProduct(
                    parseInt(locationState.id),
                    parseInt(locationState.musicPrice)
                  );
                }}
              >
                BUY NOW
